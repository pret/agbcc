...
#include <sys/procfs.h>]], [[$1 avar]])],[bfd_cv_have_sys_procfs_type_$1=yes],[bfd_cv_have_sys_procfs_type_$1=no
   ])])
...
/* Needed for new procfs interface on sparc-solaris.  */
#define _STRUCTURED_PROC 1
#include <sys/procfs.h>]], [[$1 avar; void* aref = (void*) &avar.$2]])],[bfd_cv_have_sys_procfs_type_member_$1_$2=yes],[bfd_cv_have_sys_procfs_type_member_$1_$2=no
   ])])
