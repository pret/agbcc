...
static const char *buffer_line(file_info_type *file, char *line, unsigned int size)
{
...
static void rebuffer_line(file_info_type *  file,
                          unsigned int linenum,
                          char *            buffer,
                          unsigned int size)
{
...
static void emit_line(list_info_type * list, const char * format, ...)
{
    va_list args;
...
static void print_lines(list_info_type *list, unsigned int lineno,
...
static void print_source(file_info_type *  current_file,
                         list_info_type *  list,
                         unsigned int width)
{
...
static int debugging_pseudo(list_info_type *list, const char *line)
{
#ifdef OBJ_ELF
    static int in_debug;
    int was_debug;
...
static void listing_listing(char *name ATTRIBUTE_UNUSED)
{
...
static void print_single_option(char * opt, int *pos)
{
...
static void print_options(char ** argv)
{
...
static void listing_general_info(char ** argv)
{
    /* Print the stuff on the first line.  */
    eject = 1;
    listing_page(NULL);
    ...
    fprintf(list_file,
            _(" GNU assembler version %s (armv4tl-none-eabi)\n\t using BFD version %s."),
...
void listing_eject(int ignore ATTRIBUTE_UNUSED)
{
    if (listing) {
...
void listing_psize(int width_only)
{
    if (!width_only) {
...
void listing_nopage(int ignore ATTRIBUTE_UNUSED)
{
    paper_height = 0;
}
...
void listing_source_line(unsigned int line)
{
    if (listing) {
        new_frag();
...
void listing_source_file(const char *file)
{
    if (listing) {
...
void listing_eject(int ignore)
{
    s_ignore(0);
}

void listing_psize(int ignore)
{
    s_ignore(0);
}

void listing_nopage(int ignore)
{
    s_ignore(0);
}
...
void listing_newline(char *name)
{
}

void listing_source_line(unsigned int n)
{
}

void listing_source_file(const char *n)
{
}
