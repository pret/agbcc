...
fixS *fix_new(fragS *frag,            /* Which frag?  */
              int where,            /* Where in that frag?  */
              int size,             /* 1, 2, or 4 usually.  */
              symbolS *add_symbol, /* X_add_symbol.  */
              offsetT offset,       /* X_add_number.  */
...
fixS *fix_new_exp(fragS *frag,                /* Which frag?  */
                  int where,    /* Where in that frag?  */
                  int size,     /* 1, 2, or 4 usually.  */
...
void record_alignment( /* Segment to which alignment pertains.  */
    segT seg,
...
static int compress_frag(struct z_stream_s *strm, const char *contents, int in_size,
...
static void compress_debug(bfd *abfd, asection *sec, void *xxx ATTRIBUTE_UNUSED)
{
    segment_info_type *seginfo = seg_info(sec);
    fragS *f;
    fragS *first_newf;
...
long relax_frag(segT segment, fragS *fragP, long stretch)
{
