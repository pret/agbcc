...
struct hash_control *hash_new_sized(unsigned long size)
{
    unsigned long alloc;
...
static struct hash_entry *hash_lookup(struct hash_control *table, const char *key, size_t len,
...
const char *hash_insert(struct hash_control *table, const char *key, void *val)
{
    struct hash_entry *p;
    struct hash_entry **list;
    unsigned long hash;
...
const char *hash_jam(struct hash_control *table, const char *key, void *val)
{
    struct hash_entry *p;
    struct hash_entry **list;
    unsigned long hash;
...
void *hash_replace(struct hash_control *table, const char *key, void *value)
{
    struct hash_entry *p;
    void *ret;
...
void *hash_find(struct hash_control *table, const char *key)
{
    struct hash_entry *p;
...
void *hash_find_n(struct hash_control *table, const char *key, size_t len)
{
    struct hash_entry *p;
...
void *hash_delete(struct hash_control *table, const char *key, int freeme)
{
    struct hash_entry *p;
    struct hash_entry **list;
