...
static const char *const mname[12] = { "January", "February", "March", "April", "May", "June",
    ...
    for (;;)
    {
        ...
        case 'c':
            if (count < maxsize - 24)
            {
                ...
                sprintf(&s[count], " %.2d %2.2d:%2.2d:%2.2d %.4d", tim_p->tm_mday, tim_p->tm_hour,
                    tim_p->tm_min, tim_p->tm_sec, 1900 + tim_p->tm_year);
                count += 17;
            }
            else
                return 0;
        ...
        case 'd':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%.2d", tim_p->tm_mday);
                count += 2;
            }
            else
                return 0;
        ...
        case 'H':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%2.2d", tim_p->tm_hour);
                count += 2;
            }
            else
                return 0;
        ...
        case 'I':
            if (count < maxsize - 2)
            {
                if (tim_p->tm_hour == 0 || tim_p->tm_hour == 12)
                {
                    s[count++] = '1';
                    s[count++] = '2';
                }
        ...
        case 'j':
            if (count < maxsize - 3)
            {
                sprintf(&s[count], "%.3d", tim_p->tm_yday + 1);
                count += 3;
            }
            else
                return 0;
        ...
        case 'm':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%.2d", tim_p->tm_mon + 1);
                count += 2;
            }
            else
                return 0;
        ...
        case 'M':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%2.2d", tim_p->tm_min);
                count += 2;
            }
            else
                return 0;
        ...
        case 'S':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%2.2d", tim_p->tm_sec);
                count += 2;
            }
            else
                return 0;
        ...
        case 'U':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%2.2d", (tim_p->tm_yday + 7 - tim_p->tm_wday) / 7);
                count += 2;
            }
            else
                return 0;
        ...
        case 'w':
            if (count < maxsize - 1)
            {
                sprintf(&s[count], "%1.1d", tim_p->tm_wday);
                count++;
            }
            else
                return 0;
        ...
        case 'W':
            if (count < maxsize - 2)
            {
                sprintf(&s[count], "%2.2d", (tim_p->tm_yday + ((8 - tim_p->tm_wday) % 7)) / 7);
                count += 2;
            }
            else
                return 0;
        ...
        case 'x':
            if (count < maxsize - 15)
            {
                ...
                sprintf(&s[count], " %.2d %.4d", tim_p->tm_mday, 1900 + tim_p->tm_year);
                count += 8;
            }
            else
                return 0;
        ...
        case 'X':
            ...
            {
                sprintf(
                    &s[count], "%2.2d:%2.2d:%2.2d", tim_p->tm_hour, tim_p->tm_min, tim_p->tm_sec);
                count += 8;
            }
            else
                return 0;
        ...
        case 'y':
            if (count < maxsize - 2)
            {
               ...
               correct for a possible negative remainder.  */
                sprintf(&s[count], "%2.2d", (tim_p->tm_year % 100 + 100) % 100);
                count += 2;
            }
            else
                return 0;
        ...
        case 'Y':
            if (count < maxsize - 4)
            {
                sprintf(&s[count], "%.4d", 1900 + tim_p->tm_year);
                count += 4;
            }
            else
                return 0;
