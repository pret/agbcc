...
sbitmap sbitmap_alloc(int n_elms)
{
    int bytes, size, amt;
    sbitmap bmap;
...
sbitmap *sbitmap_vector_alloc(int n_vecs, int n_elms)
{
...
void sbitmap_vector_zero(sbitmap *bmap, int n_vecs)
{
    int i;
...
void sbitmap_vector_ones(sbitmap *bmap, int n_vecs)
{
    int i;
...
int sbitmap_union_of_diff(sbitmap dst, sbitmap a, sbitmap b, sbitmap c)
{
    int i, changed;
...
int sbitmap_a_and_b(sbitmap dst, sbitmap a, sbitmap b)
{
    int i, changed;
    sbitmap_ptr dstp, ap, bp;
...
int sbitmap_a_or_b(sbitmap dst, sbitmap a, sbitmap b)
{
    int i, changed;
    sbitmap_ptr dstp, ap, bp;
...
int sbitmap_a_or_b_and_c(sbitmap dst, sbitmap a, sbitmap b, sbitmap c)
{
    int i, changed;
    sbitmap_ptr dstp, ap, bp, cp;
...
int sbitmap_a_and_b_or_c(sbitmap dst, sbitmap a, sbitmap b, sbitmap c)
{
    int i, changed;
    sbitmap_ptr dstp, ap, bp, cp;
...
void sbitmap_intersect_of_predsucc(sbitmap dst, sbitmap *src, int bb, int_list_ptr *pred_succ)
{
    int_list_ptr ps;
    int ps_bb;
...
void sbitmap_union_of_predsucc(sbitmap dst, sbitmap *src, int bb, int_list_ptr *pred_succ)
{
    int_list_ptr ps;
    int ps_bb;
    int set_size = dst->size;
