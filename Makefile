...
binutils/Makefile:
	cd binutils && ./configure LDFLAGS="-s" CFLAGS="-O2" --disable-plugins --without-libtool --without-libintl --target=arm-none-eabi --program-prefix=arm-none-eabi- --disable-dependency-tracking --enable-gold=no --with-system-zlib --without-isl
